...
export default function Home() {
  return (
    <main style={{ background: '#ffffff' }}>
      {/* Hero Section */}
      <section style={{ padding: '60px 0 60px', background: '#ffffff' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            style={{ fontSize: '3.5rem', fontWeight: 900, marginBottom: '1rem', letterSpacing: '-2px', textTransform: 'uppercase' }}
          >
          ...
          <motion.p 
            ...
            style={{ color: '#64748b', fontSize: '1.2rem', maxWidth: '700px', margin: '0 auto', fontWeight: 500 }}
          >
